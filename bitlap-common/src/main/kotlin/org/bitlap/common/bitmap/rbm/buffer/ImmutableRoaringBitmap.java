...
import static org.bitlap.common.bitmap.rbm.Util.toUnsignedLong;
import static org.bitlap.common.bitmap.rbm.buffer.BufferUtil.*;
import static org.bitlap.common.bitmap.rbm.buffer.BufferUtil.highbits;
import static org.bitlap.common.bitmap.rbm.buffer.BufferUtil.lowbits;
import static org.bitlap.common.bitmap.rbm.buffer.BufferUtil.lowbitsAsInteger;
import static org.bitlap.common.bitmap.rbm.buffer.MutableRoaringBitmap.rangeSanityCheck;

/**
 * ImmutableRoaringBitmap provides a compressed immutable (cannot be modified) bitmap. It is meant
 * to be used with buffer.MutableRoaringBitmap, a derived class that adds methods
 * to modify the bitmap. Because the class ImmutableRoaringBitmap is not final and
 * because there exists one derived class (buffer.MutableRoaringBitmap), then

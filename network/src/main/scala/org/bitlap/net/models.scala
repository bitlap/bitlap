...
import org.bitlap.net.models.TypeId.TypeId
...
object models {
  ...
  object TypeId extends Enumeration {
    ...
    type TypeId = Value
    val B_TYPE_ID_UNSPECIFIED: TypeId.Value = Value(BTypeId.B_TYPE_ID_UNSPECIFIED.getNumber, BTypeId.B_TYPE_ID_UNSPECIFIED.name())
    val B_TYPE_ID_STRING_TYPE: TypeId.Value = Value(BTypeId.B_TYPE_ID_STRING_TYPE.getNumber, BTypeId.B_TYPE_ID_STRING_TYPE.name())
    val B_TYPE_ID_INT_TYPE: TypeId.Value = Value(BTypeId.B_TYPE_ID_INT_TYPE.getNumber, BTypeId.B_TYPE_ID_INT_TYPE.name())
    val B_TYPE_ID_DOUBLE_TYPE: TypeId.Value = Value(BTypeId.B_TYPE_ID_DOUBLE_TYPE.getNumber, BTypeId.B_TYPE_ID_DOUBLE_TYPE.name())
    val B_TYPE_ID_LONG_TYPE: TypeId.Value = Value(BTypeId.B_TYPE_ID_LONG_TYPE.getNumber, BTypeId.B_TYPE_ID_LONG_TYPE.name())
    val B_TYPE_ID_BOOLEAN_TYPE: TypeId.Value = Value(BTypeId.B_TYPE_ID_BOOLEAN_TYPE.getNumber, BTypeId.B_TYPE_ID_BOOLEAN_TYPE.name())
    val B_TYPE_ID_TIMESTAMP_TYPE: TypeId.Value = Value(BTypeId.B_TYPE_ID_TIMESTAMP_TYPE.getNumber, BTypeId.B_TYPE_ID_TIMESTAMP_TYPE.name())
    val B_TYPE_ID_SHORT_TYPE: TypeId.Value = Value(BTypeId.B_TYPE_ID_SHORT_TYPE.getNumber, BTypeId.B_TYPE_ID_SHORT_TYPE.name())

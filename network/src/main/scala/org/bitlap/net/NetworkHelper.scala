...
trait NetworkHelper {
  ...
  def registerMessageInstances(service: List[(String, GeneratedMessageV3)], action: (String, GeneratedMessageV3) => Unit): Unit = {
...
object NetworkHelper {
  def responseInstances(): List[(String, GeneratedMessageV3)] = {
    List(
      ...
      classOf[BExecuteStatement.BExecuteStatementReq].getName -> BExecuteStatement.BExecuteStatementResp.getDefaultInstance,
      ...
      classOf[BGetResultSetMetadata.BGetResultSetMetadataReq].getName -> BGetResultSetMetadata.BGetResultSetMetadataResp.getDefaultInstance,
    )
  }
  ...
  def requestInstances(): List[(String, GeneratedMessageV3)] = {
    List(
      ...
      classOf[BExecuteStatement.BExecuteStatementReq].getName -> BExecuteStatement.BExecuteStatementReq.getDefaultInstance,
      ...
      classOf[BGetResultSetMetadata.BGetResultSetMetadataReq].getName -> BGetResultSetMetadata.BGetResultSetMetadataReq.getDefaultInstance,
    )
  }
}

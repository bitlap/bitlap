...
class BitlapStatement(
  ...
  private def waitForOperationToComplete(): OperationStatus = {
  ...
  override def closeOnCompletion(): Unit = throw new SQLFeatureNotSupportedException("Method not supported")

  override def isCloseOnCompletion(): Boolean = throw new SQLFeatureNotSupportedException("Method not supported")
}
